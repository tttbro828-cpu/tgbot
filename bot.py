...
CASES = {
    "Деревянный кейс": {
        ...
        "rewards": [
            {"type": "coins", "value": 350, "chance": 30, "name": "350 монет"},
            {"type": "exp", "value": 200, "chance": 25, "name": "200 опыта"},
            {"type": "coins", "value": 650, "chance": 20, "name": "650 монет"},
    ...
    "Огненный кейс": {
        ...
        "rewards": [
            ...
            {"type": "coins", "value": 7000, "chance": 15, "name": "5500 монет"},
    ...
    "Ледяной кейс": {
        ...
        "rewards": [
            {"type": "coins", "value": 8000, "chance": 25, "name": "8000 монет"},
            {"type": "exp", "value": 800, "chance": 25, "name": "800 опыта"},
            {"type": "coins", "value": 17500, "chance": 15, "name": "17500 монет"},
            {"type": "exp", "value": 1500, "chance": 15, "name": "1500 опыта"},
            {"type": "buff", "value": "Посох бессмертия", "count": 2, "chance": 10, "name": "⚡Посох бессмертия x2"},
    ...
    "Ядовитый кейс": {
        ...
        "rewards": [
            {"type": "coins", "value": 20000, "chance": 25, "name": "20000 монет"},
            {"type": "shards", "value": 10, "chance": 25, "name": "10 осколков"},
            {"type": "coins", "value": 30000, "chance": 15, "name": "30000 монет"},
            {"type": "exp", "value": 4000, "chance": 15, "name": "4000 опыта"},
            {"type": "buff", "value": "Ультра-звуковой дрон", "count": 5, "chance": 10, "name": "🛸Ультра-звуковой дрон x2"},
            {"type": "buff", "value": "Алмазная пуля", "count": 4, "chance": 8, "name": "💎 Алмазная пуля x4"},
    ...
    "Электрический кейс": {
        ...
        "rewards": [
            {"type": "shards", "value": 35, "chance": 25, "name": "35 осколков"},
            {"type": "coins", "value": 150000, "chance": 25, "name": "150000 монет"},
            {"type": "exp", "value": 10000, "chance": 20, "name": "10000 опыта"},
            {"type": "buff", "value": "Энергетик", "count": 30, "chance": 15, "name": "🔋 Энергетик x30"},
            {"type": "buff", "value": "Ультра-звуковой дрон", "count": 7, "chance": 13, "name": "🛸Ультра-звуковой дрон x10"},
            {"type": "weapon", "value": "Плазменная винтовка", "chance": 3, "name": "⚡ Плазменная винтовка"}
        ]
    },
    "Тёмный кейс": {
        "emoji": "🌑",
        ...
        "rewards": [
            {"type": "shards", "value": 65, "chance": 25, "name": "65 осколков"},
            {"type": "coins", "value": 300000, "chance": 20, "name": "30000 монет"},
            {"type": "exp", "value": 20000, "chance": 15, "name": "20000 опыта"},
            {"type": "buff", "value": "Золотая пуля", "count": 25, "chance": 20, "name": "💫 Золотая пуля x25"},
            {"type": "buff", "value": "Посох бессмертия", "count": 20, "chance": 15, "name": "⚡ Посох бессмертия x20"},
            {"type": "weapon", "value": "Душелов", "chance": 5, "name": "🌑 Душелов"}
        ]
    },
    "Священный кейс": {
        "emoji": "✨",
        ...
        "rewards": [
            {"type": "shards", "value": 175, "chance": 20, "name": "175 осколков"},
            {"type": "coins", "value": 500000, "chance": 20, "name": "500000 монет"},
            {"type": "exp", "value": 100000, "chance": 5, "name": "10000 опыта"},
            {"type": "buff", "value": "Аптечка", "count": 200, "chance": 30, "name": "200 Аптечек"},
            {"type": "buff", "value": "Алмазная", "count": 40, "chance": 20, "name": "💎 Алмазная пуля x40"},
            {"type": "weapon", "value": "Небесный карабин", "chance": 5, "name": "✨ Небесный карабин"}
        ]
    },
    "Галактический кейс": {
        "emoji": "🌀",
...
def get_weapon_price_discounted(weapon_name: str) -> tuple:
    """Возвращает (цена_со_скидкой, старая_цена, скидка_%)"""
    ...
    if discount > 0 and price > 0:
        ...
        return discounted, price, discount
...
async def start(msg: Message):
    ...
    await msg.answer(
        "🌲 **Ты очнулся в глубине леса...**\n\n"
        "Холодный ветер шумит в кронах, где-то вдалеке воет волк. "
        "Ты не помнишь, как здесь оказался — но помнишь главное: "
        "чтобы выжить, ты должен охотиться.\n\n"
        "🐺 В лесу есть **Вожаки** — древние твари, что держат эти земли в страхе. "
        "Убей их всех — и лес признает тебя своим хозяином.\n\n"
        "━━━━━━━━━━━━━━━━━━━━\n\n"
        "🎯 **Как начать:**\n"
        "• Напиши **Хант** — и отправишься на первую охоту\n"
        "• Напиши **Меню** — увидишь все доступные действия\n\n"
        "💡 *Совет:* сперва осмотрись, выбери локацию и оружие. "
        "Звери здесь не любят гостей.",
        parse_mode="Markdown"
    )
...
@dp.message(lambda msg: msg.text and msg.text.lower() in ["меню", "menu", "инфо"])
async def menu_command(msg: Message):
    """Главное меню со всеми действиями"""
    user_id = msg.from_user.id

    text = (
        "🏕️ **ГЛАВНОЕ МЕНЮ ОХОТНИКА**\n\n"
        "Выбери, что будешь делать. Кнопки расположены по важности — "
        "сверху самое нужное.\n\n"
        "💡 Просто нажми на кнопку — раздел откроется сам."
    )

    kb = InlineKeyboardMarkup(inline_keyboard=[
        # ━━━ ТОП 1: САМОЕ ГЛАВНОЕ ━━━
        [
            InlineKeyboardButton(text="🍁 Ивент", callback_data=f"menu_event:{user_id}"),
            InlineKeyboardButton(text="🏹 Хант", callback_data=f"menu_hunt:{user_id}")
        ],
        # ━━━ ТОП 2: ОСНОВНОЕ ━━━
        [
            InlineKeyboardButton(text="🏪 Торговая лавка", callback_data=f"menu_shop:{user_id}"),
            InlineKeyboardButton(text="🎒 Инвентарь", callback_data=f"menu_inv:{user_id}")
        ],
        [
            InlineKeyboardButton(text="🗺️ Локации", callback_data=f"menu_locations:{user_id}"),
            InlineKeyboardButton(text="🌰 Собрать урожай", callback_data=f"menu_harvest:{user_id}")
        ],
        # ━━━ ТОП 3: АКТИВНОСТИ ━━━
        [
            InlineKeyboardButton(text="🎁 Серия", callback_data=f"menu_streak:{user_id}"),
            InlineKeyboardButton(text="❤️ Состояние", callback_data=f"menu_health:{user_id}")
        ],
        [
            InlineKeyboardButton(text="🏆 Топы", callback_data=f"menu_tops:{user_id}"),
            InlineKeyboardButton(text="🪤 Ловушки", callback_data=f"menu_traps:{user_id}")
        ],
        [
            InlineKeyboardButton(text="📜 Старейшина", callback_data=f"menu_quests:{user_id}"),
            InlineKeyboardButton(text="👥 Реферал", callback_data=f"menu_refs:{user_id}")
        ],
        # ━━━ ТОП 4: ДОПОЛНИТЕЛЬНОЕ ━━━
        [
            InlineKeyboardButton(text="🌍 Событие", callback_data=f"menu_world_event:{user_id}"),
            InlineKeyboardButton(text="🎨 Оформление", callback_data=f"menu_custom:{user_id}")
        ],
        [
            InlineKeyboardButton(text="🎖️ Престиж", callback_data=f"menu_prestige:{user_id}"),
            InlineKeyboardButton(text="🌦️ Погода", callback_data=f"menu_weather:{user_id}")
        ],
        # ━━━ ТОП 5: СПРАВОЧНОЕ ━━━
        [
            InlineKeyboardButton(text="🛡️ Выживание", callback_data=f"menu_survival:{user_id}"),
            InlineKeyboardButton(text="ℹ️ Инфо", callback_data=f"menu_help:{user_id}")
        ],
        [
            InlineKeyboardButton(text="❓ Справка", callback_data=f"menu_spravka:{user_id}")
        ]
    ])
...
async def menu_callback(call: CallbackQuery):
    ...
    При нажатии на кнопку бот имитирует, что игрок написал команду вручную:
    показывает в чате строку с командой и вызывает соответствующую функцию.
    """
    try:
        parts = call.data.split(":")
        action = parts[0].replace("menu_", "")
        user_id = int(parts[1])
        ...
        # Маппинг действий на текстовые команды
        commands_map = {
            "event": "ивент",
            "hunt": "хант",
            "shop": "магазин",
        ...
        command_text = commands_map.get(action)
        if not command_text:
            await call.answer("❌ Неизвестная команда", show_alert=True)
            return

        # Показываем в чате, будто игрок написал команду
        username = call.from_user.username or call.from_user.first_name
        await call.message.answer(
            f"👤 **{username}:** `{command_text}`",
            parse_mode="Markdown"
        )
        ...
        class FakeMessage:
            """Эмуляция объекта Message для вызова хендлеров напрямую"""
            def __init__(self, original_call, text):
        ...
        fake_msg = FakeMessage(call, command_text)

        # Вызываем нужную функцию
        if action == "event":
            await event_command(fake_msg)
        elif action == "hunt":
            await hunt(fake_msg)
        elif action == "shop":
            await shop(fake_msg)
        elif action == "inv":
            await inventory(fake_msg)
        elif action == "locations":
            await choose_location(fake_msg)
        elif action == "harvest":
            await harvest_command(fake_msg)
        elif action == "streak":
            await daily_streak(fake_msg)
        elif action == "health":
            await health_status(fake_msg)
        elif action == "tops":
            await top(fake_msg)
        elif action == "traps":
            await traps_command(fake_msg)
        elif action == "quests":
            await quests_command(fake_msg)
        elif action == "refs":
            await referral_command(fake_msg)
        elif action == "world_event":
            await world_event_command(fake_msg)
        elif action == "custom":
            await customization(fake_msg)
        elif action == "prestige":
            await prestige_command(fake_msg)
        elif action == "weather":
            await show_weather(fake_msg)
        elif action == "survival":
            await survival_command(fake_msg)
        elif action == "help":
            await help_command_info(fake_msg)
        elif action == "spravka":
            await help_command_spravka(fake_msg)

    except Exception as e:
        print(f"Ошибка в menu_callback: {e}")
        import traceback
        traceback.print_exc()
        try:
            await call.answer("❌ Ошибка при открытии раздела", show_alert=True)
        except:
            pass
...
async def weapons_group_menu(call: CallbackQuery):
    try:
        ...
        for weapon_name, weapon_data in group_data["weapons"].items():
            ...
            if obtain_type == "shop":
                price, old_price, disc = get_weapon_price_discounted(weapon_name)
                if disc > 0:
                    suffix = f" — ~~{old_price}~~ {price}💰"
                else:
                    suffix = f" — {price}💰"
...
async def weapon_info(call: CallbackQuery):
    try:
        ...
        user = ensure_user(call.from_user.id)
        weapon_data = get_weapon_data(weapon)
        price, old_price, disc = get_weapon_price_discounted(weapon)
        ...
        if owned:
            ...
            if obtain_type == "shop":
                if disc > 0:
                    price_display = f"~~{old_price}~~ {price}"
                else:
                ...
                if user[1] >= price:
                    ...
                    status_text = f"✅ Достаточно средств (скидка {disc}%)" if disc > 0 else "✅ Достаточно средств"
                else:
                    kb = InlineKeyboardMarkup(inline_keyboard=[
        ...
        if price > 0:
            if disc > 0:
                text += f"💰 Цена: ~~{old_price}~~ {price} монет (скидка {disc}%)\n"
            else:
...
async def buy_weapon(call: CallbackQuery):
    try:
        ...
        if disc > 0:
            price_line = f"💰 Цена: ~~{old_price}~~ {price} (скидка {disc}%)"
        else:
            price_line = f"💰 Цена: {price}"
        await call.message.edit_text(
            f"❓ **Купить {weapon}?**\n\n{price_line}\n\n💳 Баланс: {user[1]} → {user[1] - price}",
            reply_markup=kb, parse_mode="Markdown"
        )
...
# Применяем скидку от события
        discount = get_event_shop_discount()
        if discount > 0 and price_coins > 0:
            old_price = price_coins
            price_coins = int(price_coins * (1 - discount / 100))
        owned = user_cases.get(case_name, 0)
...
# Применяем скидку от события
    ...
    if price_coins > 0 and price_shards > 0:
        ...
        if discount > 0:
            price_str = f"~~{old_price}~~ {price_coins}💰 (скидка {discount}%)"
        else:
            price_str = f"{price_coins}💰"
    elif price_shards > 0:
        price_str = f"{price_shards}🔮"
...
def update_database():
    ...
    for table_name, create_sql in tables_to_check:
        ...
        # Миграция temp_hunt — добавляем animal_id если нет
    try:
        sql.execute("SELECT animal_id FROM temp_hunt LIMIT 1")
    except sqlite3.OperationalError:
        try:
            sql.execute("ALTER TABLE temp_hunt ADD COLUMN animal_id TEXT")
            db.commit()
            print("✅ Добавлена колонка animal_id в temp_hunt")
        except Exception as e:
            print(f"❌ Ошибка миграции temp_hunt: {e}")
    
    # Аналогично для mutation
    try:
        sql.execute("SELECT mutation FROM temp_hunt LIMIT 1")
    except sqlite3.OperationalError:
        try:
            sql.execute("ALTER TABLE temp_hunt ADD COLUMN mutation TEXT")
            db.commit()
            print("✅ Добавлена колонка mutation в temp_hunt")
        except Exception as e:
            print(f"❌ Ошибка миграции temp_hunt: {e}")
